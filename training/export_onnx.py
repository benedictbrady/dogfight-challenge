...
def export(model_path: str, output_path: str, validate: bool = True,
    ...
    actor = ActorOnly.from_actor_critic(ac, obs_dim=obs_dim)
    actor.eval()

    # Dummy input — always use the model's native obs_dim
...
if __name__ == "__main__":
    ...
    parser.add_argument("--obs-dim", type=int, default=OBS_SIZE,
                        help="Observation dimension the model was trained with")
